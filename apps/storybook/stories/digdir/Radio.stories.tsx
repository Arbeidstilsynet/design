...
export const Group: StoryFn<typeof Fieldset> = () => (
  <Fieldset>
...
export const WithError: StoryFn<typeof Fieldset> = () => (
  <Fieldset>
...
export const ReadOnly: StoryFn<typeof Fieldset> = () => (
  <Fieldset>
    <Fieldset.Legend>Hvilken bydel bor du i?</Fieldset.Legend>
    <Fieldset.Description>
      Trondheim er delt inn i fire bydeler
...
export const End: StoryFn<typeof Fieldset> = () => (
  <Fieldset>
    <Fieldset.Legend>Hvilken iskremsmak er best?</Fieldset.Legend>
    <Fieldset.Description>
      Velg din favorittsmak blant alternativene.
